use crate::scene::{Scene, Camera, Point, Vec3};
...
impl AutoCamera {
    ...
    pub fn generate_cameras(scene: &Scene) -> Result<AutoCameraResult, String> {
        let bounds = scene.compute_finite_bounds()
    ...
    fn generate_perspective_camera(center: Point, size: &Vec3, margin_factor: f64) -> Result<Camera, String> {
...
mod tests {
    use super::*;
    use crate::scene::{Object, Material, Light, SceneSettings};
